...
// тут this не сработает

// Teacher 17 Teacher 17 11:45
// ну или нужно будет сделать один экземпляр и использовать его
// и получается что вызывается статик метод который дергает обычный метод а так как экземпляра конкретного нет то нет и контекста